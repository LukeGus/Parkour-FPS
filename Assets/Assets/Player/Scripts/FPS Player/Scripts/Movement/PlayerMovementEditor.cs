...
namespace cowsins
{
    ...
    {
        private string[] tabs = { "Assignables", "Movement", "Camera", "Sliding", "Jumping", "Stamina", "Wallrun", "Wall Bounce", "Grappling Hook", "Climbing Ladders", "Others" };
            ...
            if (currentTab >= 0 || currentTab < tabs.Length)
            {
                switch (tabs[currentTab])
                {
                    case "Assignables":
                        ...
                        EditorGUILayout.PropertyField(serializedObject.FindProperty("weaponCamera"));
 ...
 EditorGUI.indentLevel++;
                    ...
                    case "Stamina":
                        ...
                        break;
                    case "Wallrun":
                        EditorGUILayout.LabelField("WALLRUN", EditorStyles.boldLabel);
                        ...
                        break;
                    case "Wall Bounce":
                        EditorGUILayout.LabelField("WALL BOUNCE", EditorStyles.boldLabel);
                        ...
                        break;
                    case "Grappling Hook":
                        EditorGUILayout.LabelField("GRAPPLING HOOK", EditorStyles.boldLabel);
                        EditorGUILayout.PropertyField(serializedObject.FindProperty("allowGrapple"));
                        if (myScript.allowGrapple)
                        {
                            EditorGUI.indentLevel++;
                            EditorGUILayout.PropertyField(serializedObject.FindProperty("grappleRenderer"));
