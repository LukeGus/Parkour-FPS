...
namespace cowsins
{
    public class WeaponBob : MonoBehaviour
    {
        ...
        private void DetailedBob()
        {
            ...
            transform.localPosition = Vector3.Lerp(transform.localPosition, bobPos, Time.deltaTime * translationSpeed);
            ...
            transform.localRotation = Quaternion.Slerp(transform.localRotation, Quaternion.Euler(bobRot), Time.deltaTime * rotationSpeed);
        }
