...
namespace cowsins
{
    ...
    public class UIController : MonoBehaviour
    {
        ...
        private void Start()
        {
            intManager = playerStates.GetComponent<InteractManager>();
            weaponStates.inspectionUI = inspectionUI;
            if (experienceManager.useExperience) UpdateXP();
            if (!coinManager.useCoins && coinsUI != null) coinsUI.SetActive(false);
        }
        private void Update()
        {
            ...
            if (experienceManager.useExperience)
            {  // Calculate the target XP value
        ...
        // INTERACTION /////////////////////////////////////////////////////////////////////////////////////////
        public void AllowedInteraction(string displayText)
        {
        ...
        public void ForbiddenInteraction()
        {
        ...
        public void InteractioProgressUpdate(float value)
        {
        ...
        {
            if (!experienceManager.useExperience) return;
        ...
        public void UpdateCoins(int amount) => coinsText.text = coinManager.coins.ToString();
            ...
            if (currentTab >= 0 || currentTab < tabs.Length)
            {
                switch (tabs[currentTab])
                {
                    ...
                    case "Others":
                        ...
                        EditorGUILayout.PropertyField(serializedObject.FindProperty("experienceManager"));
